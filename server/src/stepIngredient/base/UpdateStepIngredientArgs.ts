...
@ArgsType()
class UpdateStepIngredientArgs {
  @Field(() => StepIngredientWhereUniqueInput, { nullable: false })
  where!: StepIngredientWhereUniqueInput;
  @Field(() => StepIngredientUpdateInput, { nullable: false })
  data!: StepIngredientUpdateInput;
}

export { UpdateStepIngredientArgs };
